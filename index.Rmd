...
author: "Jingtong Feng and Zhaohu(Jonathan) Fan"
output:
  html_document:
    fig_height: 7
    fig_width: 9
...
```{r, tidy = TRUE, echo = FALSE}
#This map seems much more informative. It reveals a giant hotspot in the Harlem neighborhood, with smaller hotspots in the surrounding neighborhoods. Additionally, there are spots in the southern Bronx area.
#So pull the map in to focus on these areas. Additionally, lets look at maps by specific category of crime.
